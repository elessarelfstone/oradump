...
class OraDumpAsrUralskTests(unittest.TestCase):
	...
	def test_asr_uralsk_tdr_for_first_five_days_of_feb(self):
		...
		csv = self.csv_dir / "{}_{}-{}".format("asr_uralsk", date_for_csv(params["dtbegin"]), date_for_csv(params["dtend"]))
		template_path = Path("../templates/db.tdr.sqtmpl")
